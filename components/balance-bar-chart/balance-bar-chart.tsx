...
import { TIME_PERIODS, PROJECTION_SETTINGS_KEY, COMPOUND_FREQUENCY_OPTIONS } from "./constants"
import { BalanceChartTooltip } from "./chart-tooltip"
        ...
        <div className="aspect-[2/1] md:aspect-[7/2] w-full select-none">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              {shouldRenderTooltip && (
                <Tooltip
                  content={<BalanceChartTooltip period={selectedPeriod} formatCurrency={formatCurrency} />}
